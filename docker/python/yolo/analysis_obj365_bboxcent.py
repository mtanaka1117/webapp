...
def analysis(input_csv_path, output_csv_path, result_dir):
    ...
    header = ["id", "label", "arrival_time", "stay_time", "count", "day_of_week", "x1", "y1", "x2", "y2", "x_cent", "y_cent", "width", "height", "place", "is_touch"]
                    ...
                    #物体が一定時間を超えて再び確認された場合
                        ...
                        with open(output_csv_path, 'a', newline='') as w:
                            ...
                            if (label_dict[label_index][2] > MIN_DATA_THRES):
                                ...
                                x_cent, y_cent, width, height = label_dict[label_index][4]
